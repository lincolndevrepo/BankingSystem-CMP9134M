(function (global, factory) {
    ...
    var defaultConfig = {
        ...
        errorTextParent: 'form-group-parent',
        errorTextTag: 'label',
        errorTextClass: 'text-help'
    };

    var PRISTINE_ERROR = 'error';
    ...
    function Pristine(form, config, live) {
        ...
        function _getErrorElements(field) {
            ...
            if (self.config.classTo === self.config.errorTextParent) {
                ...
                errorTextParent = findAncestor(errorClassElement, self.config.errorTextParent); // Find the correct parent based on the errorTextParent configuration
            }
            if (errorTextParent) {
